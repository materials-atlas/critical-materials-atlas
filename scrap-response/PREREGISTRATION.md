...
## Result of Amendment A - run 2026-09-17: **the two metals that can answer, answer no**
...
**Aluminium and lead can see the filed threshold, and they show nothing.** Their own series would have
...
The other five cannot see 0.20 on their own and are reported as untestable, not as nulls.
...
used moves no estimate by more than 0.04, and changes no reading. The attenuation excuse offered for
the pooled null does not survive: the null is not an artefact of measuring price badly.
...
Read down the columns: after a real price rise, **consumption falls** in the three largest metals, and
for aluminium **primary output rises**, while secondary supply sits still. The recycled share climbs in
a price spike because the market is using less of the metal, not because more scrap comes back. This
is a hypothesis generated by the data, and it needs its own pre-registered test on other countries
before it is worth more than a sentence.
