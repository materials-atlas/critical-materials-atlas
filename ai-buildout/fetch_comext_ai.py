# -*- coding: utf-8 -*-
"""Fetch the EU customs record (Eurostat Comext monthly, CN8) for the AI build-out page's lines, 2024-01 on.
...
def fetch(url, path=None, tries=5):
    for i in range(tries):
        try:
            req = urllib.request.Request(url, headers={'User-Agent': 'critical-materials-atlas/ai-buildout'})
