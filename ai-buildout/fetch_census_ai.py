# -*- coding: utf-8 -*-
"""Fetch US general imports (Census international trade API) for the AI build-out page's lines, 2024 on.
...
PREFIXES = ['854231', '854232', '854239', '85414',
...
FIELDS = ['CTY_CODE', 'CTY_NAME', 'I_COMMODITY', 'GEN_VAL_MO', 'SUMMARY_LVL']
YEARS = {2024: 12, 2025: 12, 2026: 7}
    ...
    for i in range(tries):
        try:
            with urllib.request.urlopen(urllib.request.Request(
                    url, headers={'User-Agent': 'critical-materials-atlas/ai-buildout'}), timeout=300) as r:
                body = r.read()
